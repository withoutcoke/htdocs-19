...
class Menus {
	...
	public function add_menu() {
		...
		add_menu_page(
			...
			'mmp_view_maps',
			'mapsmarkerpro_maps',
			array(MMP::get_instance('MMP\Menu_Maps'), 'display'),
		...
		add_submenu_page(
			...
			'mmp_add_maps',
			'mapsmarkerpro_map',
			array(MMP::get_instance('MMP\Menu_Map'), 'display')
		);
		add_submenu_page(
			'mapsmarkerpro_maps',
			...
			array(MMP::get_instance('MMP\Menu_Markers'), 'display')
		);
		add_submenu_page(
			'mapsmarkerpro_maps',
			...
			array(MMP::get_instance('MMP\Menu_Marker'), 'display')
		);
		add_submenu_page(
			'mapsmarkerpro_maps',
			...
			'mmp_use_tools',
			'mapsmarkerpro_tools',
			array(MMP::get_instance('MMP\Menu_Tools'), 'display')
		);
		add_submenu_page(
			'mapsmarkerpro_maps',
			...
			array(MMP::get_instance('MMP\Menu_Settings'), 'display')
		);
		add_submenu_page(
			'mapsmarkerpro_maps',
			...
			array(MMP::get_instance('MMP\Menu_License'), 'display')
		);
		add_submenu_page(
			'mapsmarkerpro_maps',
			...
			array(MMP::get_instance('MMP\Menu_Support'), 'display')
		);
	}
