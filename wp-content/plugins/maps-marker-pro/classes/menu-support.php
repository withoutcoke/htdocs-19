...
class Menu_Support extends Menu {
	/**
	 * Registers the hooks
	 *
	 * @since 4.0
	...
	protected function show() {
		...
		<div class="wrap mmp-wrap">
			...
			<div class="mmp-main">
				...
				<ul>
					<li>- <a href="http://www.leafletjs.com" target="_blank">Leaflet</a> by Vladimir Agafonkin (<a href="https://github.com/Leaflet/Leaflet/blob/master/LICENSE" target="_blank">License</a>)</li>
					<li>- <a href="https://github.com/codeofsumit/leaflet.pm" target="_blank">Leaflet.PM</a> by Sumit Kumar (<a href="https://github.com/codeofsumit/leaflet.pm/blob/develop/LICENSE" target="_blank">License</a>)</li>
					<li>- <a href="https://github.com/Leaflet/Leaflet.markercluster" target="_blank">Marker Clustering plugin</a> by David Leaver (<a href="https://github.com/Leaflet/Leaflet.markercluster/blob/master/MIT-LICENCE.txt" target="_blank">License</a>)</li>
					<li>- <a href="https://gitlab.com/IvanSanchez/Leaflet.GridLayer.GoogleMutant" target="_blank">Google Maps plugin</a> by Iván Sánchez Ortega (<a href="https://gitlab.com/IvanSanchez/Leaflet.GridLayer.GoogleMutant/blob/master/LICENSE" target="_blank">License</a>)</li>
					<li>- <a href="https://github.com/digidem/leaflet-bing-layer" target="_blank">Bing Maps plugin</a> by Digital Democracy (<a href="https://opensource.org/licenses/MIT" target="_blank">License</a>)</li>
					<li>- <a href="https://github.com/mapbox/Leaflet.fullscreen" target="_blank">Fullscreen plugin</a> by MapBox (<a href="https://github.com/Leaflet/Leaflet.fullscreen/blob/gh-pages/LICENSE" target="_blank">License</a>)</li>
					<li>- <a href="https://github.com/Norkart/Leaflet-MiniMap" target="_blank">MiniMap plugin</a> by Norkart (<a href="https://github.com/Norkart/Leaflet-MiniMap/blob/master/LICENSE.txt" target="_blank">License</a>)</li>
					<li>- <a href="https://github.com/domoritz/leaflet-locatecontrol" target="_blank">Locate plugin</a> by Dominik Moritz (<a href="https://github.com/domoritz/leaflet-locatecontrol/blob/gh-pages/LICENSE" target="_blank">License</a>)</li>
					<li>- <a href="https://www.openstreetmap.org" target="_blank">OpenStreetMap</a> (<a href="https://opendatacommons.org/licenses/odbl/" target="_blank">License</a>)</li>
					<li>- <a href="https://mapicons.mapsmarker.com" target="_blank">Map Icons Collection</a> by Nicolas Mollet (<a href="https://mapicons.mapsmarker.com/about/license/" target="_blank">License</a>)</li>
					<li>- Plus, JSON, layer, language, exclamation, CSV export & preview markers icons by <a href="http://p.yusukekamiyamane.com/" target="_blank">Yusuke Kamiyamane</a></li>
					<li>- Home icon by <a href="http://prothemedesign.com/" target="_blank">Pro Theme Design</a></li>
					<li>- Map edit icon by <a href="http://www.fatcow.com/" target="_blank">FatCow Web Hosting</a></li>
					<li>- Fullscreen icons by <a href="http://somerandomdude.com/" target="_blank">P.J. Onori</a></li>
				</ul>
				...
				<img src="<?= plugins_url('images/logo-mapsmarker-pro.svg', __DIR__) ?>" />
			</div>
		</div>
		<?php
	}
