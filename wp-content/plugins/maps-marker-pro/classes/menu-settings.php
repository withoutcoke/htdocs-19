...
class Menu_Settings extends Menu {
	...
	public function init() {
		...
		add_action('wp_ajax_mmp_flush_rewrite_rules', array($this, 'flush_rewrite_rules'));
	}
	...
	public function save_settings() {
		...
		$basemaps = $mmp_settings->get_basemaps(true, false);
		...
		wp_send_json(array(
			...
			'flush' => (MMP::$settings['permalinkSlug'] !== $settings['permalinkSlug'])
		));
	}
				...
				<div class="mmp-settings-wrap">
					...
					<div class="mmp-settings-tabs">
						...
						<div id="layers_google_tab" class="mmp-settings-tab">
							<h2>Google Maps</h2>
							<p>
								<a href="https://www.mapsmarker.com/google-maps-javascript-api/" target="_blank"><img src="<?= plugins_url('images/geocoding/google-maps-logo.png', __DIR__) ?>" /></a><br />
						...
						<div id="layers_bing_tab" class="mmp-settings-tab">
							<h2>Bing Maps</h2>
							<p>
								<a href="https://www.mapsmarker.com/bing-maps/" target="_blank"><img src="<?= plugins_url('images/geocoding/bing-maps-logo.png', __DIR__) ?>" /></a><br />
						...
						<div id="layers_here_tab" class="mmp-settings-tab">
							<h2>HERE Maps</h2>
							<p>
								<a href="https://www.mapsmarker.com/here-maps/" target="_blank"><img src="<?= plugins_url('images/geocoding/here-logo.png', __DIR__) ?>" /></a><br />
						...
						<div id="layers_tom_tab" class="mmp-settings-tab">
							<h2>TomTom</h2>
							<p>
								<a href="https://www.mapsmarker.com/tomtom/" target="_blank"><img src="<?= plugins_url('images/geocoding/tomtom-logo.png', __DIR__) ?>" /></a><br />
						...
						<div id="geocoding_tomtom_tab" class="mmp-settings-tab">
							...
							<p>
								<a href="https://www.mapsmarker.com/tomtom-geocoding/" target="_blank"><img src="<?= plugins_url('images/geocoding/tomtom-logo.png', __DIR__) ?>" /></a><br />
			...
			<div id="mmp-custom-layer-modal" class="mmp-admin-modal">
				<div class="mmp-admin-modal-content">
					...
					<div class="mmp-admin-modal-footer">
						...
						<button id="mmp-custom-layer-delete" class="button"><?= esc_html__('Delete', 'mmp') ?></button>
					</div>
				</div>
			</div>
		</div>
