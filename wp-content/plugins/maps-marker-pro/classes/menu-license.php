...
class Menu_License extends Menu {
	/**
	 * Registers the hooks
	 *
	 * @since 4.0
		...
		<div class="wrap mmp-wrap">
			...
			<?php else: ?>
				<div class="mmp-main mmp-license-section">
					<h2>
						<img class="mmp-license-icon" src="<?= plugins_url('images/icons/license-option-a.svg', __DIR__) ?>" />
				...
				<div class="mmp-main mmp-license-section">
					<h2>
						<img class="mmp-license-icon" src="<?= plugins_url('images/icons/license-option-b.svg', __DIR__) ?>" />
				...
				<div class="mmp-main mmp-license-section">
					<h2>
						<img class="mmp-license-icon" src="<?= plugins_url('images/icons/license-option-c.svg', __DIR__) ?>" />
