...
class WP_Data_Access_Public
{
    ...
    public function enqueue_scripts()
    {
        ...
        // Just enqueue: jquery is already registered.
        ...
        wp_register_script(
            'wpdadiehard',
            '/wp-admin/load-scripts.php?load%5B%5D=hoverIntent,common,hoverintent-js,list-tables,forms,buttons',
            [],
            $wp_version
        );
        wp_register_script(
    ...
    public function wpdadiehard( $atts )
    {
        ...
        // wp_enqueue_script( 'wpdadiehard' ); // Returns errors in WP 5.5
