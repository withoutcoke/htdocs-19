 ...
 * @since   3.1.5
 */
function wpda_auto_update_setting_html( $html, $plugin_file, $plugin_data )
{
    if ( 'wp-data-access/wp-data-access.php' === $plugin_file ) {
        $html = __( 'Auto-updates are not available for this plugin', 'wp-data-access' );
    }
    return $html;
}
