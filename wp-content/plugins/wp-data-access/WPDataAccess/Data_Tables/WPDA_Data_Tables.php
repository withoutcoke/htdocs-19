	...
	class WPDA_Data_Tables {
		...
		public function show(
			...
			return
				...
				"	<thead>" . $this->show_header( $columns, $responsive, $responsive_cols, $pub_format, $hyperlinks ) . "</thead>" .
		 ...
		 * @param string $hyperlinks Hyperlinks defined in column settings.
		 *
		 * @return HTML output
		 */
		protected function show_header( $columns, $responsive, $responsive_cols, $pub_format, $hyperlinks, $add_data_attribute = false ) {
			$count       = 0;
			$html_output = '';
			...
			foreach ( $columns as $column ) {
				...
				$data_attribute = $add_data_attribute ? 'data-column_name="' . $column . '"' : '';
