...
namespace WPDataAccess\Utilities {
	...
	class WPDA_Repository {
		...
		protected function cleanup() {
			...
			$updates[] = "update " . WPDP_Page_Model::get_base_table_name() . " set page_schema_name = '{$wpdb->dbname}' where page_schema_name = ''";
			$updates[] = "update " . WPDP_Project_Design_Table_Model::get_base_table_name() . " set wpda_schema_name = '{$wpdb->dbname}' where wpda_schema_name = ''";
