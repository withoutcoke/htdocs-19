...
$cfg['blowfish_secret']					= '%(e<<LyYEt3-:X7vm,W\"y,4=k?g9@O((' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= 'https://www.withoutcoke.ml/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_SE6WP7R2VMNy8KrDs5I0bfZ/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
