...
$this->_settings['clustering_helptext2'] = array(
		...
		*/
		$this->_settings['misc_language_helptext'] = array(
			...
			'std'     => '',
			'title'   => '',
			'desc'    => __('The interface language to use on backend and/or on maps on frontend. Please note that the language for Google Maps and Bing maps can be set separately via the according basemap settings section.','lmm') . '<br/><br/>' . sprintf(__('If your language is missing or not fully translated yet, you are invited to help on the <a href="%1s" target="_blank">web-based translation plattform</a>.','lmm'), 'https://translate.mapsmarker.com/'),
			'type'    => 'helptext'
		);
