...
<?php
/*****************************************************************************************/
echo '<p style="margin:0.5em 0 0 0;clear:both;"><strong>' . sprintf($text_a, '3.12.3') . '</strong> - ' . $text_b . ' 06.01.2020 (<a href="https://www.mapsmarker.com/v3.12.3" target="_blank">' . $text_c . '</a>):</p>
<table>
<tr><td>' . $new . '</td><td>
<div style="line-height:16px;padding:10px 0;font-weight:bold;">Leaflet Maps Marker has earned its retirement - existing users get a parting gift: a 50% coupon code for an unexpiring Maps Marker Pro license (<a href="https://demo.mapsmarker.com" target="_blank">view demo</a>).<br/>For a limited time only, get yours now! <a href="https://www.mapsmarker.com/v3.12.3" target="_blank">Read more & get 50% coupon code</a></div>
</td></tr>
<tr><td>' . $fixed . '</td><td>
...
if ( (version_compare($lmm_version_old,"3.12.2","<")) && ( $lmm_version_old > '0' ) ) {
