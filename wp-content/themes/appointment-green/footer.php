...
<div class="footer-copyright-section">
    <div class="container">
        <div class="row">
            ...
            <?php
            if ($appointment_green_footer_setting['footer_social_media_enabled'] == 0) {
                        ...
                        <?php if ($appointment_green_footer_setting['footer_social_media_facebook_link'] != '') { ?>
                            ...
                            <li class="linkedin"><a href="<?php echo esc_url($appointment_green_footer_linkdin); ?>" <?php
                                ...
                                ?> ><i class="fa fa-linkedin"></i></a></li>
                                                <?php } if ($appointment_green_footer_setting['footer_social_media_googleplus_link'] != '') { ?>
                            <li class="googleplus"><a href="<?php echo esc_url($appointment_green_footer_googleplus); ?>" <?php
                                if ($appointment_green_footer_setting['footer_googleplus_media_enabled'] == 1) {
                                    echo "target='_blank'";
                                }
