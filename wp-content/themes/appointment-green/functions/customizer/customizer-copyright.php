...
// Footer copyright section 
    ...
    array(
        'default' => '<p>'.__( '<a href="https://wordpress.org">Proudly powered by WordPress</a> | Theme: <a href="https://webriti.com" rel="nofollow">Appointment Green</a> by Webriti', 'appointment-green' ).'</p>',
...
$wp_customize->add_control(
    ...
    'appointment_options[footer_social_media_googleplus_link]',
    array(
        'label' => esc_html__('GooglePlus URL','appointment-green'),
        'section' => 'copyright_social_icon',
        'type' => 'text',
    )
	);
