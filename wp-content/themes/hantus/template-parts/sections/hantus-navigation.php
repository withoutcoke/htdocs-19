...
<?php } ?>
									...
									<li class="search-button">
										<div class="sb-search">
											<form action="<?php echo esc_url( home_url( '/' ) ); ?>">
												...
												<button type="button" id='search-clicker' class="sb-icon-search"><i class="fa <?php echo esc_attr( $hantus_header_search ); ?>"></i></button>
											</form>
										</div>
									</li>
									<?php } ?>
    ...
    ============================= -->
<?php 
	if ( !is_page_template( 'templates/template-homepage.php' || 'templates/template-homepage-two.php' ) ) {
