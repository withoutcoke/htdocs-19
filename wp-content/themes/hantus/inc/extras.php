...
add_action( 'wp_ajax_hantus_business_dismissed_notice_handler', 'hantus_ajax_notice_handler' );

/**
 * AJAX handler to store the state of dismissible notices.
 */
function hantus_ajax_notice_handler() {
    if ( isset( $_POST['type'] ) ) {
...
function hantus_deprecated_hook_admin_notice() {
        ...
        if ( ! get_option('dismissed-get_started', FALSE ) ) {
            ...
            <div class="updated notice notice-get-started-class is-dismissible" data-notice="get_started">
                <div class="hantus-getting-started-notice clearfix">
                    <div class="hantus-theme-screenshot">
                        <img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/screenshot.png" class="screenshot" alt="<?php esc_attr_e( 'Theme Screenshot', 'hantus' ); ?>" />
                    </div><!-- /.hantus-theme-screenshot -->
                    <div class="hantus-theme-notice-content">
                        <h2 class="hantus-notice-h2">
                            <?php
                        printf(
                        /* translators: 1: welcome page link starting html tag, 2: welcome page link ending html tag. */
                            esc_html__( 'Welcome! Thank you for choosing %1$s!', 'hantus' ), '<strong>'. wp_get_theme()->get('Name'). '</strong>' );
                        ?>
                        </h2>

                        <p class="plugin-install-notice"><?php echo sprintf(__('Install and activate <strong>Clever Fox</strong> plugin for taking full advantage of all the features this theme has to offer.', 'hantus')) ?></p>

                        <a class="hantus-btn-get-started button button-primary button-hero hantus-button-padding" href="#" data-name="" data-slug=""><?php esc_html_e( 'Get started with Hantus', 'hantus' ) ?></a><span class="hantus-push-down">
                        <?php
                        ...
                        ?>
                    </div><!-- /.hantus-theme-notice-content -->
                </div>
            </div>
        <?php }
}

add_action( 'admin_notices', 'hantus_deprecated_hook_admin_notice' );

/*******************************************************************************
 *  Plugin Installer
 *******************************************************************************/

add_action( 'wp_ajax_install_act_plugin', 'hantus_admin_install_plugin' );

function hantus_admin_install_plugin() {
    /**
     * Install Plugin.
     */
