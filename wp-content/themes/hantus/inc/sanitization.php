 ...
 */
function hantus_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function hantus_sanitize_css( $css ) {
 ...
 */
function hantus_sanitize_email( $email, $setting ) {
 ...
 */
function hantus_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function hantus_sanitize_html( $html ) {
 ...
 */
function hantus_sanitize_image( $image, $setting ) {
 ...
 */
function hantus_sanitize_nohtml( $nohtml ) {
 ...
 */
function hantus_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function hantus_sanitize_number_range( $number, $setting ) {
 ...
 */
function hantus_sanitize_select( $input, $setting ) {
 ...
 */
function hantus_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function hantus_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function hantus_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}

function hantus_sanitize_select_icon( $input, $setting ) {
	
	// Ensure input is a slug.
	$choice = hantus_get_icons();
