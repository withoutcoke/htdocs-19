/* global jQuery */
/* global wp */
function hantus_media_upload(button_class) {
    'use strict';
 ...
 *** Generate unique id ***
 *********************************************/
function hantus_customizer_repeater_uniqid(prefix, more_entropy) {
    'use strict';
 ...
 *** General Repeater ***
 *********************************************/
function hantus_customizer_repeater_refresh_social_icons(th) {
    'use strict';
    ...
    th.find('.customizer-repeater-social-repeater-container').each(function () {
        ...
        if (!id) {
            id = 'customizer-repeater-social-repeater-' + hantus_customizer_repeater_uniqid();
    ...
    hantus_customizer_repeater_refresh_general_control_values();
}


function hantus_customizer_repeater_refresh_general_control_values() {
    'use strict';
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            if (!id) {
                id = 'social-repeater-' + hantus_customizer_repeater_uniqid();
            ...
            if (text !== '' || image_url !== '' || title !== '' || subtitle !== '' || icon_value !== '' || link !== '' || choice !== '' || social_repeater !== '' || shortcode !== '' || slide_align !== '' || color !== '') {
                values.push({
                    ...
                    'color': color,
                    'color2': color2,
                    'text': hantusescapeHtml(text),
                    'link': link,
                    'text2': hantusescapeHtml(text2),
                    'link2': link2,
                    'image_url': (choice === 'customizer_repeater_none' ? '' : image_url),
                    'choice': choice,
                    'title': hantusescapeHtml(title),
                    'subtitle': hantusescapeHtml(subtitle),
					'designation': hantusescapeHtml(designation),
					'slide_align': hantusescapeHtml(slide_align),
                    'social_repeater': hantusescapeHtml(social_repeater),
                    'id': id,
                    'shortcode': hantusescapeHtml(shortcode)
                });
            }
...
jQuery(document).ready(function () {
    'use strict';
    var hantus_theme_controls = jQuery('#customize-theme-controls');
    hantus_theme_controls.on('click', '.customizer-repeater-customize-control-title', function () {
    ...
    hantus_theme_controls.on('change', '.icp',function(){
        hantus_customizer_repeater_refresh_general_control_values();
        return false;
    });
	
	hantus_theme_controls.on('change','.customizer-repeater-slide-align', function(){
		hantus_customizer_repeater_refresh_general_control_values();
        return false;
		
	});
	
    hantus_theme_controls.on('change', '.customizer-repeater-image-choice', function () {
    ...
    hantus_media_upload('.customizer-repeater-custom-media-button');
     ...
     *
     */
    hantus_theme_controls.on('click', '.customizer-repeater-new-field', function () {
        var split_add_more_button=jQuery(this).text();
        var split_add_more_button_split=split_add_more_button.substr(4, 12);
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-' + hantus_customizer_repeater_uniqid();
		
		if(split_add_more_button_split=="Add New Slid")
        {
        if(jQuery('#exist_hantus_Slider').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_hantus_Slider').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_hantus_Slider').val())+1;
         jQuery('#exist_hantus_Slider').val(new_service_add_val);  
        }
        }
		
		 if(split_add_more_button_split=="Add New Serv")
        {
        if(jQuery('#exist_hantus_Service').val()>=4)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_hantus_Service').val()<4)
        {
         var new_service_add_val=parseInt(jQuery('#exist_hantus_Service').val())+1;
         jQuery('#exist_hantus_Service').val(new_service_add_val);  
        }
        }
         if(split_add_more_button_split=="Add New Test")
        {
        if(jQuery('#exist_hantus_Testimonial').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_hantus_Testimonial').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_hantus_Testimonial').val())+1;
         jQuery('#exist_hantus_Testimonial').val(new_service_add_val);  
        }
        }
    ...
    hantus_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                ...
                {
                jQuery('#exist_hantus_Slider').val(parseInt(jQuery('#exist_hantus_Slider').val())-1);  
                }
				if(split_delete_button_split=="Delete Servi")
                {
                jQuery('#exist_hantus_Service').val(parseInt(jQuery('#exist_hantus_Service').val())-1);  
                }
				if(split_delete_button_split=="Delete Testi")
                {
                jQuery('#exist_hantus_Testimonial').val(parseInt(jQuery('#exist_hantus_Testimonial').val())-1); 
                }
            });
        }
        return false;
    ...
    hantus_theme_controls.on('keyup', '.customizer-repeater-title-control', function () {
        hantus_customizer_repeater_refresh_general_control_values();
    });
    ...
    hantus_theme_controls.on('keyup', '.customizer-repeater-subtitle-control', function () {
        hantus_customizer_repeater_refresh_general_control_values();
    });

    hantus_theme_controls.on('keyup', '.customizer-repeater-shortcode-control', function () {
        hantus_customizer_repeater_refresh_general_control_values();
    });

    hantus_theme_controls.on('keyup', '.customizer-repeater-text-control', function () {
        hantus_customizer_repeater_refresh_general_control_values();
    });

    hantus_theme_controls.on('keyup', '.customizer-repeater-link-control', function () {
        hantus_customizer_repeater_refresh_general_control_values();
    });

    hantus_theme_controls.on('keyup', '.customizer-repeater-text2-control', function () {
        hantus_customizer_repeater_refresh_general_control_values();
    });

    hantus_theme_controls.on('keyup', '.customizer-repeater-link2-control', function () {
        hantus_customizer_repeater_refresh_general_control_values();
    });
	
	hantus_theme_controls.on('keyup', '.customizer-repeater-designation-control', function () {
        hantus_customizer_repeater_refresh_general_control_values();
    });
    ...
    /*----------------- Socials Repeater ---------------------*/
    hantus_theme_controls.on('click', '.social-repeater-add-social-item', function (event) {
        event.preventDefault();
        var th = jQuery(this).parent();
        var id = 'customizer-repeater-social-repeater-' + hantus_customizer_repeater_uniqid();
        if (typeof th !== 'undefined') {
    ...
    hantus_theme_controls.on('click', '.social-repeater-remove-social-item', function (event) {
        event.preventDefault();
        var th = jQuery(this).parent();
        var repeater = jQuery(this).parent().parent();
        th.remove();
        hantus_customizer_repeater_refresh_social_icons(repeater);
        return false;
    });

    hantus_theme_controls.on('keyup', '.customizer-repeater-social-repeater-link', function (event) {
        event.preventDefault();
        var repeater = jQuery(this).parent().parent();
        hantus_customizer_repeater_refresh_social_icons(repeater);
        return false;
    ...
    hantus_theme_controls.on('change', '.customizer-repeater-social-repeater-container .icp', function (event) {
        event.preventDefault();
...
function hantusescapeHtml(string) {
    'use strict';
    //noinspection JSUnresolvedFunction
    string = String(string).replace(new RegExp('\r?\n', 'g'), '<br />');
    string = String(string).replace(/\\/g, '&#92;');
    return String(string).replace(/[&<>"'\/]/g, function (s) {
        return hantusentityMap[s];
    });
